...
"""
    string for running : 
    python3 -u test.py --model_path /home/yotama/semantic-segmentation-pytorch/baseline-resnet50dilated-ppm_deepsup  
    --test_imgs ~/semantic-segmentation-pytorch/2.jpg  --arch_encoder resnet50dilated --arch_decoder ppm_deepsup
    """